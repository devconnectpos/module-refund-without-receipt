...
class InstallSchema implements InstallSchemaInterface
{
    ...
    {
        $this->createRefundWithoutReceiptTransactionTable($setup);
        $this->createRefundWithoutReceiptItemTable($setup);
    }
    ...
    {
        $output->writeln('  |__ Create refund without receipt transaction table');
        $this->createRefundWithoutReceiptTransactionTable($setup);
        $output->writeln('  |__ Create refund without receipt item table');
        $this->createRefundWithoutReceiptItemTable($setup);
    }
